...
const (
	...
	MatchmakerServiceName = "rpc.matchmaking.v1.MatchmakerService"
)

// MatchmakerServiceClient is a client for the rpc.matchmaking.v1.MatchmakerService service.
...
// NewMatchmakerServiceClient constructs a client for the rpc.matchmaking.v1.MatchmakerService
...
func NewMatchmakerServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) MatchmakerServiceClient {
	...
	return &matchmakerServiceClient{
		findMatch: connect_go.NewClient[v1.FindMatchRequest, v1.FindMatchResponse](
			httpClient,
			baseURL+"/rpc.matchmaking.v1.MatchmakerService/FindMatch",
			opts...,
		),
		reportMatchResult: connect_go.NewClient[v1.ReportMatchResultRequest, v1.ReportMatchResultResponse](
			httpClient,
			baseURL+"/rpc.matchmaking.v1.MatchmakerService/ReportMatchResult",
			opts...,
		),
	}
}
...
// FindMatch calls rpc.matchmaking.v1.MatchmakerService.FindMatch.
...
// ReportMatchResult calls rpc.matchmaking.v1.MatchmakerService.ReportMatchResult.
...
// MatchmakerServiceHandler is an implementation of the rpc.matchmaking.v1.MatchmakerService
// service.
...
func NewMatchmakerServiceHandler(svc MatchmakerServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/rpc.matchmaking.v1.MatchmakerService/FindMatch", connect_go.NewUnaryHandler(
		"/rpc.matchmaking.v1.MatchmakerService/FindMatch",
		svc.FindMatch,
		opts...,
	))
	mux.Handle("/rpc.matchmaking.v1.MatchmakerService/ReportMatchResult", connect_go.NewUnaryHandler(
		"/rpc.matchmaking.v1.MatchmakerService/ReportMatchResult",
		svc.ReportMatchResult,
		opts...,
	))
	return "/rpc.matchmaking.v1.MatchmakerService/", mux
}
...
func (UnimplementedMatchmakerServiceHandler) FindMatch(context.Context, *connect_go.Request[v1.FindMatchRequest]) (*connect_go.Response[v1.FindMatchResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("rpc.matchmaking.v1.MatchmakerService.FindMatch is not implemented"))
}
...
func (UnimplementedMatchmakerServiceHandler) ReportMatchResult(context.Context, *connect_go.Request[v1.ReportMatchResultRequest]) (*connect_go.Response[v1.ReportMatchResultResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("rpc.matchmaking.v1.MatchmakerService.ReportMatchResult is not implemented"))
}
